...
const messageListener = (msg) => {
  ...
  // Only handle messages for this customer
  if (msg.customerId.toString() !== user._id.toString()) return;

  // Only show notifications for admin → customer messages
  if (msg.target !== "customer" || msg.sender !== "admin") return;

  // ✅ Only admin messages are considered
